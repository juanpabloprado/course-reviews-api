...
public class DatabaseLoader implements ApplicationRunner {
  ...
  @Override public void run(ApplicationArguments args) throws Exception {
    ...
    List<User> students = Arrays.asList(
        ...
        new User("k_freemansmith", "Karen", "Freeman-Smith", "password",
        ...
        new User("christophernowack", "Christopher", "Nowack", "password",
            new String[] {"ROLE_USER"}),
    ...
    users.save(students);
    users.save(
        new User("juanpablo", "Juan", "Prado", "12345", new String[] {"ROLE_USER", "ROLE_ADMIN"}));
